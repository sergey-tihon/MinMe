...
class MainViewModel : ViewModelBase
{
    ...
    )
    {
        ...
        _isBusy = stateService.IsBusy.ToProperty(this, nameof(IsBusy), deferSubscription: true);
        _fileContentInfo = stateService.FileContentInfo.ToProperty(
            this,
            nameof(FileContentInfo),
